...
public class Select : MonoBehaviour {
	...
	void OnGUI ()
	{
		...
		if(_GDB.selectList.Count == 1)
		{
			...
			GUI.Box(new Rect(0, 40, 150*_GDB.selectList[0].GetComponent<Stats>().lengthHealth, 30), "");
			
			GUI.Label(new Rect(0, 70, 100, 50), "DAMAGE  " + _GDB.selectList[0].GetComponent<Stats>().damage.ToString().ToUpper());
			GUI.Label(new Rect(0, 100, 100, 50), "PROTECTION  " + _GDB.selectList[0].GetComponent<Stats>().protect.ToString().ToUpper());
		}
