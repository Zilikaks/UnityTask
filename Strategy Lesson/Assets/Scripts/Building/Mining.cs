...
public class Mining : MonoBehaviour 
{
    ...
    void Start () 
	{
        ...
        uiObject = GameObject.FindGameObjectWithTag("CanvasMid").transform.Find("Mine").gameObject;
        ...
        incomingText = uiObject.transform.Find("TextStats").Find("TextIncomeValue").GetComponent<Text>();
